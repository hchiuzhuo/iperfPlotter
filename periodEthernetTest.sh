...
echo "--------------------------------"
echo ""
echo "Did you set your IP address?"
echo "sudo ifconfig eth0 192.168.1.10 netmask 255.255.255.0 up"
echo ""
echo ""
echo "Please start iperf server on the SLAVE PC"
echo "iperf3 -s"
echo "sudo ip netns add usb"
echo "sudo ip link set enx74da384a1fb8 netns usb"
echo "sudo ip netns exec usb ip l set enx74da384a1fb8 up"
echo "sudo ip netns exec usb ip address change 192.168.1.1/24 dev enx74da384a1fb8"
echo "sudo ip netns exec usb iperf3 -s"
echo ""
